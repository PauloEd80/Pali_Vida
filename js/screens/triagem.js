...
(function () {
  const { escaparHtml, header, footer, ligarNavegacaoInferior, svgMic } = PV.ui;
  ...
  async function triagem(main, ctx) {
    ...
    function medidorHtml() {
      ...
      return `
        <div class="pv-triagem-medidor">
          ...
          <div class="pv-triagem-barra-fundo">
            <div class="pv-triagem-barra-indicador" style="left:${pos}%"></div>
          </div>
          <div class="pv-triagem-legendas">
            <span class="verde"><i class="pv-ponto"></i>Adequado</span>
            <span class="amarelo"><i class="pv-ponto"></i>Observar</span>
            <span class="vermelho"><i class="pv-ponto"></i>Atenção</span>
          </div>
    ...
    main.querySelectorAll('[data-ir]').forEach((btn) => {
      if (btn.closest('.pv-footer, .pv-tabbar')) return;
