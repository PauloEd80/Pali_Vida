...
(function () {
  ...
  function montarPainel() {
    ...
    botaoEl.innerHTML = '<svg viewBox="0 0 24 24" width="20" height="20" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" xmlns="http://www.w3.org/2000/svg" aria-hidden="true"><rect x="5" y="4" width="14" height="17" rx="2"/><path d="M9 4V3a1 1 0 011-1h4a1 1 0 011 1v1"/><path d="M9 11h6M9 15h6M9 19h3"/></svg>';
  ...
  function injetarEstilos() {
    ...
    style.textContent = `
      ...
      /* O atributo [hidden] precisa vencer o "display:flex" acima — sem isto,
         o painel fica invisível mas continua ocupando espaço/clicável. */
      #pv-relatorio-painel[hidden] { display: none; }
